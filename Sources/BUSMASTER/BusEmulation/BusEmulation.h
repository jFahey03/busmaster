...
EXTERN_C const IID IID_ISimENG;
    ...
    typedef struct ISimENGVtbl
    {
        ...
        DECLSPEC_XFGVIRT(ISimENG, SendMessage)
        ...
        DECLSPEC_XFGVIRT(ISimENG, RegisterClient)
        ...
        DECLSPEC_XFGVIRT(ISimENG, GetCurrentStatus)
