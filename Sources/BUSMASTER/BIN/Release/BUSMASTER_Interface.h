...
EXTERN_C const IID IID__IAppEvents;
    ...
    typedef struct _IAppEventsVtbl
    {
        ...
        DECLSPEC_XFGVIRT(_IAppEvents, OnMessageReceived)
...
EXTERN_C const IID IID_IBusMasterApp;
    ...
    typedef struct IBusMasterAppVtbl
    {
        ...
        DECLSPEC_XFGVIRT(IBusMasterApp, Connect)
        /* [helpstring][id] */ HRESULT ( STDMETHODCALLTYPE *Connect )( 
            IBusMasterApp * This,
            BOOL bConnect);
        
        DECLSPEC_XFGVIRT(IBusMasterApp, GetMsgInfo)
        /* [helpstring][id] */ HRESULT ( STDMETHODCALLTYPE *GetMsgInfo )( 
            IBusMasterApp * This,
            BSTR MsgName,
            sMESSAGESTRUCT *sMsgStruct);
        
        DECLSPEC_XFGVIRT(IBusMasterApp, GetNetworkStatistics)
        /* [helpstring][id] */ HRESULT ( STDMETHODCALLTYPE *GetNetworkStatistics )( 
            IBusMasterApp * This,
            int nChannel,
            sBUSSTATISTICS_USR *sStat);
        
        DECLSPEC_XFGVIRT(IBusMasterApp, GetErrorCounter)
        ...
        DECLSPEC_XFGVIRT(IBusMasterApp, ImportDatabase)
        /* [helpstring][id] */ HRESULT ( STDMETHODCALLTYPE *ImportDatabase )( 
            IBusMasterApp * This,
            BSTR DBFilePath);
        
        DECLSPEC_XFGVIRT(IBusMasterApp, LoadConfiguration)
        /* [helpstring][id] */ HRESULT ( STDMETHODCALLTYPE *LoadConfiguration )( 
            IBusMasterApp * This,
            BSTR FileName);
        
        DECLSPEC_XFGVIRT(IBusMasterApp, SaveConfiguration)
        /* [helpstring][id] */ HRESULT ( STDMETHODCALLTYPE *SaveConfiguration )( 
            IBusMasterApp * This);
        
        DECLSPEC_XFGVIRT(IBusMasterApp, SaveConfigurationAs)
        /* [helpstring][id] */ HRESULT ( STDMETHODCALLTYPE *SaveConfigurationAs )( 
            IBusMasterApp * This,
            BSTR ConfigPath);
        
        DECLSPEC_XFGVIRT(IBusMasterApp, RegisterClientForRx)
        ...
        DECLSPEC_XFGVIRT(IBusMasterApp, UnRegisterClient)
...
EXTERN_C const IID IID_ICANComm;
    ...
    typedef struct ICANCommVtbl
    {
        ...
        DECLSPEC_XFGVIRT(ICANComm, SendCANMSg)
        /* [helpstring][id] */ HRESULT ( STDMETHODCALLTYPE *SendCANMSg )( 
            ICANComm * This,
            CAN_MSGS *sMsg);
        
        DECLSPEC_XFGVIRT(ICANComm, GetApplication)
